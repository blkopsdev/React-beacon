...
export const MANAGE_MEASUREMENT_POINT_LIST_ADD_SUCCESS =
  'MANAGE_MEASUREMENT_POINT_LIST_ADD_SUCCESS';
export const MANAGE_MEASUREMENT_POINT_LIST_ADD_FAILED =
  'MANAGE_MEASUREMENT_POINT_LIST_ADD_FAILED';
export const MANAGE_MEASUREMENT_POINT_LIST_UPDATE_SUCCESS =
  'MANAGE_MEASUREMENT_POINT_LIST_UPDATE_SUCCESS';
...
export const MANAGE_MEASUREMENT_POINT_QUESTION_DELETE_SUCCESS =
  'MANAGE_MEASUREMENT_POINT_QUESTION_DELETE_SUCCESS';
export const MANAGE_MEASUREMENT_POINT_QUESTION_DELETE_FAILED =
  'MANAGE_MEASUREMENT_POINT_QUESTION_DELETE_FAILED';

export const TOGGLE_MODAL_EDIT_MEASUREMENT_POINT_LISTS =
  'TOGGLE_MODAL_EDIT_MEASUREMENT_POINT_LISTS';
export const TOGGLE_MODAL_EDIT_MEASUREMENT_POINT_QUESTION =
  'TOGGLE_MODAL_EDIT_MEASUREMENT_POINT_QUESTION';

export const MANAGE_MEASUREMENT_POINT_QUESTION_ADD =
  'MANAGE_MEASUREMENT_POINT_QUESTION_ADD';
