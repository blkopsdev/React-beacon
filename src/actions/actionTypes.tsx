...
export const TEAM_UPDATE_SUCCESS = 'USER_UPDATE_SUCCESS';
export const TEAM_UPDATE_FAILED = 'USER_UPDATE_FAILED';
export const TEAM_SAVE_SUCCESS = 'USER_SAVE_SUCCESS';
export const TEAM_SAVE_FAILED = 'USER_SAVE_FAILED';
export const TOGGLE_MODAL_EDIT_TEAM = 'TOGGLE_MODAL_EDIT_TEAM';
export const TOGGLE_MODAL_SAVE_TEAM = 'TOGGLE_MODAL_SAVE_TEAM';
