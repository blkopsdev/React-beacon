...
export const saveAlert = (alert: IAlert | FormData) => (): ThunkResult<
  void
> => {
...
export const updateAlert = (alert: IAlert | FormData) => (): ThunkResult<
  void
> => {
  return async dispatch => {
    dispatch(beginAjaxCall());
...
export const deleteAlert = (alert: IAlert) => (): ThunkResult<void> => {
  return async dispatch => {
    dispatch(beginAjaxCall());
    const axiosOptions: AxiosRequestConfig = {
      method: 'delete'
