...
export const GET_MEASUREMENT_POINT_JOB_RESULTS_SUCCESS =
  'GET_MEASUREMENT_POINT_JOB_RESULTS_SUCCESS';
export const GET_MEASUREMENT_POINT_JOB_RESULTS_FAILED =
  'GET_MEASUREMENT_POINT_JOB_RESULTS_FAILED';
