...
export const CUSTOMER_IMAGE_SAVE_SUCCESS = 'CUSTOMER_IMAGE_SAVE_SUCCESS';
export const GET_CUSTOMER_IMAGE_SUCCESS = 'GET_CUSTOMER_IMAGE_SUCCESS';
export const GET_CUSTOMER_IMAGE_FAILED = 'GET_CUSTOMER_IMAGE_FAILED';
